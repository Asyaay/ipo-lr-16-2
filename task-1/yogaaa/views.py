...
class CategoryViewSet(viewsets.ModelViewSet):
    # API представление для просмотра и редактирования категорий занятий йогой
    queryset = Category.objects.all()
    serializer_class = CategorySerializer

class ManufacturerViewSet(viewsets.ModelViewSet):
    # API представление для просмотра и редактирования студий/залов йоги
    queryset = Manufacturer.objects.all()
    serializer_class = ManufacturerSerializer

class ProductViewSet(viewsets.ModelViewSet):
    # API представление для просмотра и редактирования услуг/абонементов йоги
    queryset = Product.objects.all()
    serializer_class = ProductSerializer

class CartViewSet(viewsets.ModelViewSet):
    # API представление для просмотра и редактирования корзин пользователей
    queryset = Cart.objects.all()
    serializer_class = CartSerializer

class CartItemViewSet(viewsets.ModelViewSet):
    # API представление для просмотра и редактирования элементов внутри корзины
