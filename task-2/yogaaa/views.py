...
def update_cart(request, item_id):
    ...
    return render(request, 'cart.html', {'cart': cart, 'error_message': error_message}) #открываем страницу корзины с ошибкой
...
def cart_view(request):
    ...
    return render(request, 'cart.html', {'cart': cart}) #отображение всех элементов корзины с общей стоимостью по заданию
