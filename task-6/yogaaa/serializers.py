...
class ProfileSerializer(serializers.ModelSerializer):
    # Сериализатор для профиля текущего пользователя (Задание 3, пункты 1 и 2)
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'role'] # роль изменять через API нельзя из соображений безопасности
